...
from CelebA.dataset import load_data, find_class_imbalance
from CelebA.config import BASE_DIR, N_CLASSES, N_ATTRIBUTES, UPWEIGHT_RATIO, MIN_LR, LR_DECAY_SIZE
...
def parse_arguments(experiment, seed, argv):
    ...
    if experiment == 'Probe':
        ...
        args.log_dir = os.path.join(args.log_dir, 'CelebA'+str(seed), experiment)
        return (args,)
